...
int main()
{
	...
	{
		std::cout << "Dame un numero de zero a infito. \n";
		std::cin >> num1;

		std::cout << "Que accion quieres realizar. \n" <<
			"1- Suma, 2- Resta, 3- Multiplicacion, 4- Division, 5- Potencia, 6- Valor absoluto, 7- Mayor menor que. \n";
		std::cin >> operador;
		...
		case 7:
			std::cout << "Dime dos numeros y te dire cual es mayor o menor: \n";
			int a, b;
			a = 0, b = 0;
			...
			if (a > b)
				std::cout << "Este es mayor que b: \n";

			{if (b > a)
				std::cout << "b es mayor que a: \n";
			{
				if (a = b)
					std::cout << "Mismo resultado. :): \n";
				{
